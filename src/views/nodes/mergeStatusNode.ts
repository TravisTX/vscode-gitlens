...
import { GitBranch, GitFile, MergeStatus, StatusFileFormatter } from '../../git/git';
import { GitUri } from '../../git/gitUri';
import { Arrays, Strings } from '../../system';
import { View, ViewsWithFiles } from '../viewBase';
import { ContextValues, ViewNode } from './viewNode';
import { ViewFilesLayout } from '../../configuration';

export class MergeStatusNode extends ViewNode<ViewsWithFiles> {
	static key = ':merge';
	...
	constructor(
		...
		public readonly status: MergeStatus,
	) {
...
export class MergeConflictFileNode extends ViewNode implements FileNode {
	constructor(view: View, parent: ViewNode, private readonly status: MergeStatus, public readonly file: GitFile) {
...
export class MergeConflictCurrentChangesNode extends ViewNode {
	constructor(view: View, parent: ViewNode, private readonly status: MergeStatus, private readonly file: GitFile) {
